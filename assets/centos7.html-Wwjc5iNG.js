import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as c,c as p,a as e,d as a,w as s,e as n,b as r}from"./app-72EeZQJA.js";const u={},m=e("h1",{id:"centos-7",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#centos-7"},[e("span",null,"CentOS 7")])],-1),v=e("p",null,"在本指南中，我们将安装 Pterodactyl v1.X（包括它的所有依赖项）并配置我们的网络服务器以使用 SSL 为其提供服务。",-1),b={class:"table-of-contents"},h={class:"hint-container tip"},g=e("p",{class:"hint-container-title"},"提示",-1),f=e("h2",{id:"install-requirements-and-additional-utilities",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#install-requirements-and-additional-utilities"},[e("span",null,"Install Requirements and Additional Utilities")])],-1),_=r(`<div class="hint-container tip"><p class="hint-container-title">提示</p><p>If you run <code>sestatus</code> and it shows <code>SELinux status: enabled</code> you should install the following packages for later</p></div><h3 id="selinux-tools" tabindex="-1"><a class="header-anchor" href="#selinux-tools"><span>SELinux tools</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> policycoreutils policycoreutils-python selinux-policy selinux-policy-targeted libselinux-utils setroubleshoot-server setools setools-console mcstrans
