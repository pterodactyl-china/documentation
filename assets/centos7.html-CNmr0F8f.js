import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r,c as d,a as n,e,b as s,w as i,d as l,o}from"./app-SIiQDxOa.js";const c={},p=n("h1",{id:"centos-7",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#centos-7"},[n("span",null,"CentOS 7")])],-1),m=n("p",null,"在本指南中，我们将安装 Pterodactyl v1.X（包括它的所有依赖项）并配置我们的网络服务器以使用 SSL 为其提供服务。",-1),u={class:"hint-container tip"},v=n("p",{class:"hint-container-title"},"提示",-1),b=n("h2",{id:"安装要求和附加工具",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#安装要求和附加工具"},[n("span",null,"安装要求和附加工具")])],-1),h=l(`<div class="hint-container tip"><p class="hint-container-title">提示</p><p>If you run <code>sestatus</code> and it shows <code>SELinux status: enabled</code> you should install the following packages for later</p></div><h3 id="selinux-tools" tabindex="-1"><a class="header-anchor" href="#selinux-tools"><span>SELinux tools</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> policycoreutils policycoreutils-python selinux-policy selinux-policy-targeted libselinux-utils setroubleshoot-server setools setools-console mcstrans
