import{_ as d}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o,c,a as e,e as n,b as a,w as s,d as l}from"./app-DxlKfuuV.js";const p={},m=e("h1",{id:"centos-8-rocky-linux-8-almalinux-8-fedora-server-38",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#centos-8-rocky-linux-8-almalinux-8-fedora-server-38"},[e("span",null,"CentOS 8, Rocky Linux 8, AlmaLinux 8, Fedora Server 38")])],-1),u=e("p",null,"在本指南中，我们将安装 Pterodactyl v1.X（包括它的所有依赖项）并配置我们的网络服务器以使用 SSL 为其提供服务。",-1),v={class:"hint-container tip"},h=e("p",{class:"hint-container-title"},"提示",-1),b=e("h2",{id:"install-requirements-and-additional-utilities",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#install-requirements-and-additional-utilities"},[e("span",null,"Install Requirements and Additional Utilities")])],-1),g=l(`<div class="hint-container tip"><p class="hint-container-title">提示</p><p>If you run <code>sestatus</code> and it shows <code>SELinux status: enabled</code> you should install the following packages for later</p></div><h3 id="selinux-tools" tabindex="-1"><a class="header-anchor" href="#selinux-tools"><span>SELinux tools</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>dnf <span class="token function">install</span> <span class="token parameter variable">-y</span> policycoreutils selinux-policy selinux-policy-targeted setroubleshoot-server setools setools-console mcstrans
