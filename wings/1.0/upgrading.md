...
curl -L -o /usr/local/bin/wings "https://gh.api.99988866.xyz/https://github.com/pterodactyl-china/wings/releases/latest/download/wings_linux_$([[ "$(uname -m)" == "x86_64" ]] && echo "amd64" || echo "arm64")"
```
