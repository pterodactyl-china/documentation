...
**DO NOT** use this guide to upgrade from `0.5.X` to `0.6.X`, it will not work and you will encounter errors afterwards. Please check the [0.5 to 0.6](0.5_to_0.6.md) upgrade documentation to perform that update.
:::
